...
void bindHiggsPredictions(pybind11::module &higgs) {
    ...
    py::class_<NeutralEffectiveCouplings>(hp, "NeutralEffectiveCouplings")
        .def(py::init<std::complex<double>, std::complex<double>,
             ...
             "ZZ"_a = 0, "Zgam"_a = 0, "gamgam"_a = 0, "gg"_a = 0, "lam"_a = 0)
        .def(
            "__repr__",
            [](const NeutralEffectiveCouplings &self) {
                return fmt::format(
                    ...
                    self.Zgam, self.gamgam, self.gg, self.lam);
            })
        ...
        .def_readwrite("lam", &NeutralEffectiveCouplings::lam);
    ...
    hpEffCCxns.def("cbHm", EffectiveCouplingCxns::cbHm, "collider"_a, "mHm"_a,
                   "gLcb"_a, "gRcb"_a);
    hpEffCCxns.def("hhvbf", EffectiveCouplingCxns::hhvbf, "collider"_a, "mH"_a,
                   "lam"_a, "tt"_a, "bb"_a);
    hpEffCCxns.def("hhggh", EffectiveCouplingCxns::hhggh, "collider"_a, "mH"_a,
                   "lam"_a, "tt"_a, "bb"_a);
