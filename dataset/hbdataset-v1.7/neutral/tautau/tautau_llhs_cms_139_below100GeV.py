...
newbasepath = "HEPData-ins2132368mod_below100GeV/"
...
data["id"] = 2208027171
data["source"] = "Tab. 11 a-b and Tab. 41-42 (obs) & same but +Asimov (exp)"
...
with open("LLH_LHC13_CMS_139_below100GeV.json", "w") as f:
    json.dump(data, f)
